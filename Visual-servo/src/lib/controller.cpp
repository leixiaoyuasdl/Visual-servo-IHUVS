...
void controller::position_control()
{
    ...
    //dy.at<double>(2)=fp_goal.allcorners.at(20).x-fp.allcorners.at(20).x;
    dy.at<double>(2)=allcorners_goal.at(20).x-allcorners.at(20).x;
...
//    dy_v.push_back(fp.allcorners.at(20).x-fp_pre.allcorners.at(20).x);
    dy_v.push_back(allcorners2.at(20).x-allcorners.at(20).x);
...
//            dys.at<double>((i-1)*3+2)=fp.allcorners.at(20).x-fp_pre.allcorners.at(20).x;
            dys.at<double>((i-1)*3+2)=allcorners2.at(20).x-allcorners.at(20).x;
        ...
        if(i==1)
            target_pose.position.y = target_pose.position.y-0.01;
        if(i==2)

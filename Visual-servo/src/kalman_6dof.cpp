...
//**************************
    ofstream myfile("/home/fzt/catkin_visual/src/Visual-servo-master/data/data.txt");
    if (!myfile.is_open())
    {
        cout << "未成功打开文件" << endl;
        return 0;
...
//**************************
    ofstream myfile_frame("/home/fzt/catkin_visual/src/Visual-servo-master/data/frame.txt");
...
//**************************
    ...
    std::string path= "/home/fzt/catkin_visual/src/Visual-servo-master/goal/goal.jpg";

    std::string path_start= "/home/fzt/catkin_visual/src/Visual-servo-master/data/start.jpg";
...
//    myfile<<con.allcorners_goal.at(0)<<" "<<con.allcorners_goal.at(10)<<endl<<endl;
    ...
    myfile<<con.allcorners_goal.at(19).x<<" "<<con.allcorners_goal.at(19).y<<" ";
    myfile<<con.allcorners_goal.at(20).x<<" "<<con.allcorners_goal.at(20).y<<" ";
    myfile<<con.allcorners_goal.at(31).x<<" "<<con.allcorners_goal.at(31).y<<" "<<endl;

    double x,y,z,w;

    myfile<<con.im_p.getallcorners(con.rob.image).at(0).x<<" "<<con.im_p.getallcorners(con.rob.image).at(0).y<<" ";
    myfile<<con.im_p.getallcorners(con.rob.image).at(19).x<<" "<<con.im_p.getallcorners(con.rob.image).at(19).y<<" ";
    myfile<<con.im_p.getallcorners(con.rob.image).at(20).x<<" "<<con.im_p.getallcorners(con.rob.image).at(20).y<<" ";
    myfile<<con.im_p.getallcorners(con.rob.image).at(31).x<<" "<<con.im_p.getallcorners(con.rob.image).at(31).y<<" "<<endl;
